...
function Legend(props: TLegend) {
    return (
          <div className = {LegendStyle.line} style = {{opacity: props.active ? "1" : "0.6"}}>
              ...
              <span className = {LegendStyle.title} style = {{color: props.color, textDecorationLine: props.active ? "underline" : "none", textDecorationColor: props.color}}>{props.text+" Сегмент"}</span>
          </div>
    )}
